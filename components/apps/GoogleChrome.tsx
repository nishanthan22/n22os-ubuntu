...
export class Chrome extends Component<{}, ChromeState> {
    private home_url: string = 'https://www.google.com/webhp?igu=1';
    ...
    componentDidMount() {
        ...
        if (lastVisitedUrl && lastDisplayedUrl) {
    ...
    goToHome = () => {
        this.setState({ url: this.home_url, display_url: "https://www.google.com" }, this.refreshChrome);
    };
    ...
    handleDisplayUrl = (e: ChangeEvent<HTMLInputElement>) => {
