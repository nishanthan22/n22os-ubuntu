...
const ContextMenu: React.FC<DesktopMenuProps> = ({ active, openApp, addNewFolder }) => {
  ...
  const openTerminal = () => openApp("terminal");
  ...
  return (
    ...
    >
      <div onClick={addNewFolder} className="w-full py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5">
